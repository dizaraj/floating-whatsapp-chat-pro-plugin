 ...
 * @since 2.3.0 (Added image sanitization)
 */
 ...
 * @since 2.3.0 (Added image uploader)
 */
                    ...
                    <div class="wcw-pro-repeater-item">
                        ...
                        <div class="wcw-pro-repeater-content">
                            <div class="wcw-pro-agent-field-group">
                                ...
                                <div class="wcw-pro-agent-image-uploader">
                                    ...
                                    <button type="button" class="button wcw-pro-upload-image-button"><?php esc_html_e('Select Image', 'wcw-pro'); ?></button>
 ...
 * @since 2.3.0 (Added profile picture)
 */
...
function wcw_pro_enqueue_assets() {
    wp_enqueue_style( 'wcw-pro-style', plugin_dir_url( __FILE__ ) . 'assets/css/style.css', array(), '2.3.0' );
    wp_enqueue_script( 'wcw-pro-script', plugin_dir_url( __FILE__ ) . 'assets/js/main.js', array( 'jquery' ), '2.3.0', true );
}
add_action( 'wp_enqueue_scripts', 'wcw_pro_enqueue_assets' );

/**
 * Enqueue admin scripts.
 * @since 2.3.0 (Added media uploader script)
 */
function wcw_pro_enqueue_admin_scripts( $hook ) {
    ...
    wp_enqueue_style( 'wcw-pro-admin-style', plugin_dir_url( __FILE__ ) . 'assets/css/admin.css', array(), '2.3.0' );
    wp_enqueue_script( 'wcw-pro-admin-script', plugin_dir_url( __FILE__ ) . 'assets/js/admin.js', array( 'jquery', 'wp-util', 'wp-color-picker', 'jquery-ui-accordion' ), '2.3.0', true );
}
...
function wcw_pro_create_asset_files() {
    ...
    if ( ! file_exists( $admin_js_file ) ) file_put_contents($admin_js_file, "jQuery(function(e){\"use strict\";var c;function t(t){e(\".wcw-pro-color-picker\").wpColorPicker({change:function(t,c){var n=e(t.target).closest(\".wp-picker-container\").find(\".wp-color-picker\").attr(\"name\");\"wcw_pro_settings[bubble_color]\"===n?e(\"#wcw-pro-preview-bubble\").css(\"background-color\",c.color.toString()):\"wcw_pro_settings[icon_color]\"===n&&e(\"#wcw-pro-preview-icon\").attr(\"fill\",c.color.toString())}}),e(\"#wcw-pro-repeater\").accordion({header:\".wcw-pro-repeater-handle\",collapsible:!0,active:!1,heightStyle:\"content\"})}var n=e(\"#wcw-pro-repeater\"),a=e(\"#wcw-pro-add-agent\"),r=wp.template(\"wcw-pro-repeater-template\"),o=e('input[name=\"wcw_pro_settings[bubble_color]\"]').val(),i=e('input[name=\"wcw_pro_settings[icon_color]\"]').val();e(\"#wcw-pro-preview-bubble\").css(\"background-color\",o),e(\"#wcw-pro-preview-icon\").attr(\"fill\",i),a.on(\"click\",function(t){t.preventDefault();var a={index:n.children(\".wcw-pro-repeater-item\").length};n.append(r(a)),n.accordion(\"refresh\"),n.accordion(\"option\",\"active\",-1)}),n.on(\"click\",\".wcw-pro-remove-agent\",function(t){t.preventDefault(),e(this).closest(\".wcw-pro-repeater-item\").remove(),n.accordion(\"refresh\"),n.find(\".wcw-pro-repeater-item\").each(function(t){var n=e(this);n.find(\"input, select, textarea\").each(function(){var e=n.find(this);e.attr(\"name\",function(e,n){if(n)return n.replace(/\[\\d+\]/,\"[\"+t+\"]\")})})})}),n.on(\"keyup\",\".agent-name-field\",function(){var t=e(this).val(),c=e(this).closest(\".wcw-pro-repeater-item\").find(\".wcw-pro-repeater-handle\");c.text(t||\"New Agent\")}),n.on(\"click\",\".wcw-pro-upload-image-button\",function(t){t.preventDefault();var n=e(this),a=n.siblings(\".wcw-pro-image-id\"),r=n.siblings(\".wcw-pro-image-preview\").find(\"img\"),o=n.siblings(\".wcw-pro-remove-image-button\");c&&c.off(\"select\"),c=wp.media({title:\"Select Agent Image\",button:{text:\"Use this image\"},multiple:!1}).on(\"select\",function(){var e=c.state().get(\"selection\").first().toJSON();a.val(e.id),r.attr(\"src\",e.sizes.thumbnail.url).show(),o.show()}),c.open()}),n.on(\"click\",\".wcw-pro-remove-image-button\",function(t){t.preventDefault(),e(this).hide().siblings(\".wcw-pro-image-id\").val(\"0\").siblings(\".wcw-pro-image-preview\").find(\"img\").hide()}),e(\".wcw-pro-nav-tab-wrapper .nav-tab\").on(\"click\",function(t){t.preventDefault();var c=e(this);c.addClass(\"nav-tab-active\").siblings().removeClass(\"nav-tab-active\");var n=c.attr(\"href\");e(\".wcw-pro-tab-content\").removeClass(\"active\"),e(n).addClass(\"active\")}),t(e(\".wcw-pro-settings-wrap\"))});");
}
