...
function wcw_pro_settings_init() {
    ...
    add_settings_field('wcw_pro_api_key_field', esc_html__('License Key', 'wcw-pro'), 'wcw_pro_render_field', 'wcw_pro_settings_license', 'wcw_pro_license_section', ['type' => 'text', 'id' => 'api_key', 'description' => 'Enter your License key to unlock Pro features.']);
...
function wcw_pro_enqueue_assets() {
    wp_enqueue_style( 'wcw-pro-style', plugin_dir_url( __FILE__ ) . 'assets/css/style.css', array(), '2.6.4' );
    wp_enqueue_script( 'wcw-pro-script', plugin_dir_url( __FILE__ ) . 'assets/js/main.js', array( 'jquery' ), '2.6.4', true );
}
...
function wcw_pro_enqueue_admin_scripts( $hook ) {
    ...
    wp_enqueue_style( 'wcw-pro-admin-style', plugin_dir_url( __FILE__ ) . 'assets/css/admin.css', array(), '2.6.4' );
    wp_enqueue_script( 'wcw-pro-admin-script', plugin_dir_url( __FILE__ ) . 'assets/js/admin.js', array( 'jquery', 'wp-util', 'wp-color-picker', 'jquery-ui-accordion' ), '2.6.4', true );
