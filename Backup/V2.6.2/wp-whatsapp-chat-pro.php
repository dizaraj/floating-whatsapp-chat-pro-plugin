...
function wcw_pro_render_frontend_widget() {
    ...
    <div class="wcw-pro-container">
        <div class="<?php echo esc_attr($bubble_classes); ?>">
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="30" height="30"><path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.8 0-67.3-10.2-96.1-29.1l-6.7-4-71.6 18.7 19.3-68.6-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5c0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.8-16.2-54.3-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.9 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"/></svg>
...
function wcw_pro_enqueue_assets() {
    wp_enqueue_style( 'wcw-pro-style', plugin_dir_url( __FILE__ ) . 'assets/css/style.css', array(), '2.6.2' );
    wp_enqueue_script( 'wcw-pro-script', plugin_dir_url( __FILE__ ) . 'assets/js/main.js', array( 'jquery' ), '2.6.2', true );
}
...
function wcw_pro_output_dynamic_styles() {
    ...
    $css .= '.wcw-pro-bubble svg { fill: ' . esc_attr($icon_color) . '; }';
...
function wcw_pro_enqueue_admin_scripts( $hook ) {
    ...
    wp_enqueue_style( 'wcw-pro-admin-style', plugin_dir_url( __FILE__ ) . 'assets/css/admin.css', array(), '2.6.2' );
    wp_enqueue_script( 'wcw-pro-admin-script', plugin_dir_url( __FILE__ ) . 'assets/js/admin.js', array( 'jquery', 'wp-util', 'wp-color-picker', 'jquery-ui-accordion' ), '2.6.2', true );
...
function wcw_pro_create_asset_files() {
    ...
    $admin_js_content = "jQuery(function(e){\"use strict\";var c;var t=e(\"#wcw-pro-repeater\"),n=e(\"#wcw-pro-add-agent\"),a=wp.template(\"wcw-pro-repeater-template\"),r=e('input[name=\"wcw_pro_settings[bubble_color]\"]'),o=e('input[name=\"wcw_pro_settings[icon_color]\"]'),i=e('input[name=\"wcw_pro_settings[button_style]\"]'),d=e('input[name=\"wcw_pro_settings[button_text]\"]'),l=e(\"#wcw-pro-preview-bubble\"),s=e(\"#wcw-pro-preview-icon\"),p=e(\"#wcw-pro-preview-text\");function u(){var t=e('input[name=\"wcw_pro_settings[button_style]\"]:checked').val(),c=d.closest(\"tr\");\"icon_text\"===t?(c.show(),l.addClass(\"has-text\"),p.text(d.val())):(c.hide(),l.removeClass(\"has-text\")),w()}function w(){l.css(\"background-color\",r.val()),s.find(\"path\").attr(\"fill\",o.val()),p.css(\"color\",o.val())}e(\".wcw-pro-color-picker\").wpColorPicker({change:function(e,t){w()}}),t.accordion({header:\".wcw-pro-repeater-handle\",collapsible:!0,active:!1,heightStyle:\"content\"}),n.on(\"click\",function(c){c.preventDefault(),e(this).is(\":disabled\")||(t.append(a({index:t.children(\".wcw-pro-repeater-item\").length})),t.accordion(\"refresh\"),t.accordion(\"option\",\"active\",-1))}),t.on(\"click\",\".wcw-pro-remove-agent\",function(c){c.preventDefault();var a=e(this).closest(\".wcw-pro-repeater-item\");a.remove(),t.accordion(\"refresh\"),t.find(\".wcw-pro-repeater-item\").each(function(t){e(this).find(\"input, select, textarea\").each(function(){var c=e(this);c.attr(\"name\",function(e,t){if(t)return t.replace(/\[\\d+\]/,\"[\"+t+\"]\")})})}),wcwProData.is_pro||t.children(\".wcw-pro-repeater-item\").length<1&&n.prop(\"disabled\",!1).parent().removeClass(\"wcw-pro-locked\")}),t.on(\"keyup\",\".agent-name-field\",function(){var t=e(this).val();e(this).closest(\".wcw-pro-repeater-item\").find(\".wcw-pro-repeater-handle\").text(t||\"New Agent\")}),t.on(\"click\",\".wcw-pro-upload-image-button\",function(t){if(t.preventDefault(),!e(this).is(\":disabled\")){var n=e(this),a=n.siblings(\".wcw-pro-image-id\"),r=n.siblings(\".wcw-pro-image-preview\").find(\"img\"),o=n.siblings(\".wcw-pro-remove-image-button\");c&&c.off(\"select\"),c=wp.media({title:\"Select Agent Image\",button:{text:\"Use this image\"},multiple:!1}).on(\"select\",function(){var e=c.state().get(\"selection\").first().toJSON();a.val(e.id),r.attr(\"src\",e.sizes.thumbnail.url).show(),o.show()}),c.open()}}),t.on(\"click\",\".wcw-pro-remove-image-button\",function(t){t.preventDefault(),e(this).hide().siblings(\".wcw-pro-image-id\").val(\"0\").siblings(\".wcw-pro-image-preview\").find(\"img\").hide()}),e(\".wcw-pro-nav-tab-wrapper .nav-tab\").on(\"click\",function(t){t.preventDefault();var c=e(this);c.addClass(\"nav-tab-active\").siblings().removeClass(\"nav-tab-active\");var n=c.attr(\"href\");e(\".wcw-pro-tab-content\").removeClass(\"active\"),e(n).addClass(\"active\")}),e('input[name=\"wcw_pro_settings[button_style]\"]').on(\"change\",u),d.on(\"keyup\",function(){p.text(e(this).val())}),u(),w(),e(\"#wcw-pro-request-trial-btn\").on(\"click\",function(t){t.preventDefault();var c=e(this),n=e(\"#wcw-pro-trial-email\"),a=n.val(),r=c.siblings(\".spinner\"),o=e(\"#wcw-pro-trial-message\");return a?(r.addClass(\"is-active\"),c.prop(\"disabled\",!0),o.hide(),void e.ajax({url:ajaxurl,type:\"POST\",data:{action:\"wcw_pro_request_trial\",email:a,nonce:wcwProData.nonce},success:function(t){t.success?(o.html(t.data.message).removeClass(\"error\").addClass(\"updated notice notice-success\").show(),n.val(\"\")):o.html(t.data.message).addClass(\"error notice notice-error\").show()},error:function(){o.html(\"An unknown error occurred. Please try again.\").addClass(\"error notice notice-error\").show()},complete:function(){r.removeClass(\"is-active\"),c.prop(\"disabled\",!1)}})):(o.html(\"Please enter your email address.\").addClass(\"error notice notice-error\").show(),!1)})});";
