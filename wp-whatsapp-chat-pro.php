<?php
/*
Plugin Name: Floating WhatsApp Chat Pro
...
function wcw_pro_agents_field_callback()
{
    ...
    <div class="wcw-pro-repeater-container">
                ...
                <?php foreach ($agents as $index => $agent): ?>
                    ...
                    <div class="wcw-pro-repeater-item">
                        <div class="wcw-pro-repeater-handle">
                            <h3><span
                                    class="dashicons dashicons-admin-users"></span><?php echo esc_html($agent['name'] ?: 'New Agent'); ?>
                            </h3>
                            ...
                            <div class="wcw-pro-agent-grid">
                                <div class="wcw-pro-agent-avatar-section">
                                    ...
                                    <div class="wcw-pro-field-wrapper <?php if (!$is_pro)
                                        echo 'wcw-pro-locked'; ?>">
                                        <input type="hidden" class="wcw-pro-image-id"
                                            name="wcw_pro_settings[agents][<?php echo $index; ?>][image_id]"
                                        ...
                                        <button type="button" class="button button-link wcw-pro-remove-image-button"
                                            style="<?php echo $image_id ? '' : 'display:none;'; ?>"><?php esc_html_e('Remove', 'wcw-pro'); ?></button>
                                        <?php if (!$is_pro)
                                ...
                                <div class="wcw-pro-agent-details-section">
                                    <div class="wcw-pro-form-row">
                                        <div class="wcw-pro-form-group">
                                            ...
                                            <input class="widefat agent-name-field"
                                                name="wcw_pro_settings[agents][<?php echo $index; ?>][name]" type="text"
                                                value="<?php echo esc_attr($agent['name']); ?>" placeholder="e.g. John Doe">
                                        </div>
                                        <div class="wcw-pro-form-group">
                                            <label><?php esc_html_e('Agent Title/Role', 'wcw-pro'); ?></label>
                                            <input class="widefat" name="wcw_pro_settings[agents][<?php echo $index; ?>][title]"
                                                type="text" value="<?php echo esc_attr($agent['title']); ?>"
                                    ...
                                    <div class="wcw-pro-form-row">
                                        <div class="wcw-pro-form-group">
                                            ...
                                            <input class="widefat" name="wcw_pro_settings[agents][<?php echo $index; ?>][phone]"
                                                type="text" value="<?php echo esc_attr($agent['phone']); ?>"
                                                placeholder="e.g. +1234567890">
                                        </div>
                                        <div
                                            class="wcw-pro-form-group wcw-pro-field-wrapper <?php if (!$is_pro)
                                                echo 'wcw-pro-locked'; ?>">
                                            <label><?php esc_html_e('Department', 'wcw-pro'); ?></label>
                                            <input class="widefat"
                                                name="wcw_pro_settings[agents][<?php echo $index; ?>][department]" type="text"
                                                value="<?php echo esc_attr($agent['department'] ?? ''); ?>"
                                                placeholder="e.g. Support" <?php disabled(!$is_pro); ?>>
                                            <?php if (!$is_pro)
                                                echo '<span class="wcw-pro-badge">PRO</span>'; ?>
                                        </div>
                                    </div>
                                    <div class="wcw-pro-form-group">
                                        ...
                                        <textarea class="widefat" name="wcw_pro_settings[agents][<?php echo $index; ?>][message]"
                                            rows="3"
                                            placeholder="e.g. Hello! I have a question about..."><?php echo esc_textarea($agent['message']); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="wcw-pro-repeater-footer">
                                <a href="#" class="button button-link-delete wcw-pro-remove-agent"><span
                                        class="dashicons dashicons-trash"></span><?php esc_html_e('Remove Agent', 'wcw-pro'); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
        ...
        <div class="wcw-pro-add-agent-wrapper <?php if (!$is_pro && count($agents) >= 1)
            ...
            <a href="#" id="wcw-pro-add-agent" class="button button-primary button-large"><span
                    class="dashicons dashicons-plus-alt"></span><?php esc_html_e('Add New Agent', 'wcw-pro'); ?></a>
                ...
                <div class="wcw-pro-settings-card">
                    ...
                    <div class="wcw-pro-card-body">
                        ...
                        <ul class="wcw-pro-contact-list">
                            ...
                            <li><strong>WhatsApp:</strong> <a href="https://wa.me/8801717035081"
                                    target="_blank">+8801717035081</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="wcw-pro-sidebar-box">
                    ...
                    <div id="wcw-pro-preview-container">
                        <div id="wcw-pro-preview-bubble">
                            <svg id="wcw-pro-preview-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                width="30" height="30">
                                <path
...
/**
 * Add Google Tag Manager script to the site head.
 * @since 2.9.4
 */
function wcw_pro_add_google_tag()
{
    $google_tag_id = 'G-YP1FCV937N';
    ?>
    <!-- Google tag (gtag.js) -->
    ...
    <script>
        ...
        gtag('config', '<?php echo esc_attr($google_tag_id); ?>');
    </script>
    <?php
}
add_action('wp_head', 'wcw_pro_add_google_tag');
